        ...
        <v-card flat class="pt-15">
            ...
            <v-row>
              ...
              <v-col cols="7"
                  ...
                  <v-row>
                    <v-col cols="3" sm="4" @mouseover="showAbbreviat=true" @mouseleave="showAbbreviat=false">
                      ...
                      <v-col cols="3" sm="4" v-show="showAbbreviat" class="py-10">
                        <v-icon left inline>
                          mdi-lightbulb-on-10 
                        </v-icon>
                        <p>Аббревиатура- это ..</p>
                      </v-col>
                  </v-row>
              </v-col>
              <v-col cols="9" xs="12" class="py-0" @mouseover="showWords=true" @mouseleave="showWords=false">
              ...
              <v-col cols="3" sm="4" v-show="showWords" class="pb-3">
                <v-icon left inline>
                  mdi-lightbulb-on-10 
                </v-icon>
                <p>Ключевые слова - это ..</p>
              </v-col>
              <v-col cols="9" class="py-0" @mouseover="showDescrip=true" @mouseleave="showDescrip=false">
              ...
              <v-col cols="3" v-show="showDescrip" class="py-10">
                  ...
                  <p>Краткое описание проекта - это ..</p>
              </v-col>
            </v-row>
      ...
      <v-tab-item>
        <v-card flat class="pt-15">
          <!-- <v-form ref="form1"
            ...
            lazy-validation> -->
            <v-row>
              <v-col cols="5" @mouseover="showParentProject=true" @mouseleave="showParentProject=false"
              ...
              <v-col cols="5" sm="4" v-show="showParentProject" class="py-auto">
                    <v-icon left>
                      mdi-lightbulb-on-10 
                    </v-icon>
                    <p>Родительский проект- это ..</p>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5" @mouseover="showTypeParent=true" @mouseleave="showTypeParent=false"
                  sm="6" class="py-0 d-inline-block">
                ...
                <v-col cols="5" sm="4" v-show="showTypeParent" class="py-auto">
                    <v-icon left inline>
                      mdi-lightbulb-on-10 
                    </v-icon>
                    <p>Тип наследования зависит от ..</p>
                </v-col> 
              </v-row>
...
export default {
  data() {
    return {
      ...
      showDescrip: false,
      showWords: false,
      showParentProject: false,
      showTypeParent: false,
    ...
    saveNew() {
      ...
      if (isValid) {
        const newProject = {
          ...
          onYarmarka: this.project.onYarmarka,
